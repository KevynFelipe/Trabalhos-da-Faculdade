...
public class Prototipo_PI_com_DB {
    ...
    public static void main(String[] args) {
        ...
        switch (clas) { // CRAÇÃO DE PERSONAGEM
            ...
            case 2 -> {
                ...
                create("Galho Estranho de Eten çé!@#");
            }
        ...
        System.out.print(
                "Em uma taverna afastada, uma missão urgente circulava entre os aventureiros sobre a Floresta encantada, que agora era conhecida por ser a moradia de uma temivel fera, conhecida como Dragonfrost.\n");
        // pausar(4000);
        ...
        character[5] += roll.nextInt(1, 4); // Adiciona entre 1 a 3 poções ao inventário
        System.out.printf(
        ...
        System.out.print(
                "Caminhando até a caverna você vê a besta dormindo. Você acaba pisando em um graveto, à acordando, então você se prepara para o que poderia ser sua ultíma aventura.\n");
        while (!ok.equalsIgnoreCase("ok")) {
            System.out.println("Digite ok para continuar");
            ok = input.nextLine().trim();
        }
    ...
    private static void create(String entrada) {
        try (OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(FILE_NAME, true), "UTF-8")) {
            writer.write(entrada + System.lineSeparator());
    ...
    private static void atualizarQuantidadePocoes(int quantidade) {
        try (FileWriter writer = new FileWriter(FILE_NAME)) {
            writer.write("poções=" + quantidade);
            System.out.println("Quantidade de poções atualizada no inventário.");
        } catch (IOException e) {
                    ...
                    switch (escolhaA) {
                        ...
                        case 2 -> {
                            ...
                            if (persona[3] >= 10) {
                                ...
                                System.out.printf("%nVocê tirou %d no D20!%n", dado);
                                pausar(500);
                                if (dado >= 5) { // Acerto de bola de fogo. Essa magia possui uma chance alta de acerto,
                                                 // diferente dos outros ataques com dado 20
                ...
                if (enemy[3] == 2) { // COMBATE LADRÃO
                    ...
                    if (escolhendo == 1) {
                        ...
                        if (dado >= 10) {
                            ...
                            System.out.print("O dragão erra!\n");
                        }

                    } else {
                        int dado = d20();
                        System.out.println(
                                "O Dragonfrost te ataca com sua poderosa baforada gélida! Como algo tão frio pode queimar tanto?");
                        if (dado >= 10) {
                            ...
                            System.out.print("PORÉM ELE ERRA!\n");
                        }
                    }
                }
            }
